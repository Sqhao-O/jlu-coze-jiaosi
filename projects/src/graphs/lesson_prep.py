...
def node_simulate_classroom(state: LessonPrepState) -> dict:
    ...
    messages = [
        SystemMessage(content=CLASSROOM_SIM_SYSTEM_PROMPT),
        HumanMessage(content=user_content),
    ]
...
def node_detect_blindspots(state: LessonPrepState) -> dict:
    ...
    messages = [
        SystemMessage(content=BLIND_SPOT_SYSTEM_PROMPT),
        HumanMessage(content=user_content),
    ]
...
def node_simulate_students(state: LessonPrepState) -> dict:
    ...
    messages = [
        SystemMessage(content=STUDENT_SIM_SYSTEM_PROMPT),
        HumanMessage(content=user_content),
    ]
...
def node_design_interactions(state: LessonPrepState) -> dict:
    ...
    messages = [
        SystemMessage(content=INTERACTION_DESIGN_SYSTEM_PROMPT),
        HumanMessage(content=user_content),
    ]
...
def build_lesson_prep_graph() -> StateGraph:
    ...
    builder.add_conditional_edges("intent_router", route_intent, route_map)
